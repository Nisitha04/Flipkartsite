...
import realmebann from '../assets/images/realmebann.jpg';
...
const Phone4 = () => {
  ...
  return (
    <div className="container-fluid px-3">
      ...
      {/* Banner Image */}
      <img src={realmebann} style={{height:'350px',width:'100%'}} className="img-fluid w-100 my-3 rounded" alt="Mobile Deals Banner" />
