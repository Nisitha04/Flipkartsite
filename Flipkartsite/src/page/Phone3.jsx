...
import oppobann from '../assets/images/oppobann.jpeg';
...
const Phone3 = () => {
  ...
  return (
    <div className="container-fluid px-3">
      ...
      {/* Banner Image */}
      <img src={oppobann} style={{height:'350px',width:'100%'}} className="img-fluid w-100 my-3 rounded" alt="Mobile Deals Banner" />
